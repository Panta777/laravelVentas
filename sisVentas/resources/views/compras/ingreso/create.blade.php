...
<div class="row">
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type ="text" name="num_comprobante"  value ="{{old('num_comprobante')}}" class ="form-control" placeholder="No. de Comprobante.. ">
        </div>	
    </div>
</div>
<div class="row">
    <div class="panel panel-primary">
        <div class="panel-body">
            ...
            <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                <div class="form-group">
                    <label for="precio_compra">Precio Costo</label>
                    <input type="number" name="pprecio_compra" id="pprecio_compra" class="form-control" placeholder="P. Costo">
                </div>
            </div>
            <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                <div class="form-group">
            ...
            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                    <thead style="background-color:#D736DC">
                    <th>Opciones</th>
                    <th>Articulo</th>
                    <th>Cantidad</th>
                    <th>Precio Compra</th>
    ...
    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 " id="guardar">
        <div class="form-group">
            <input type="hidden" name="_token" value="{{csrf_token()}}" type="hidden"/> 
...
<script>
    ...
    function agregar() {
        ...
        {
            alert("Error al ingresar el detalle del ingreso, revise los datos del articulo" + idarticulo + " " + cantidad + " " + precio_compra + " " + precio_venta)
        }
